...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--reportfilter', help="Specific sections of the report to be generated. Eg. gka, household, gpcontest")
        parser.add_argument('filename')
       
    def handle(self, *args, **options):
        generate_report(options['type'], options['filename'], options['from'], options['to'], options['dry'], options['skip'], options['reportfilter'],False)
