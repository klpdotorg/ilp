...
class GPMathContestReport(BaseReport):
    ...
    def __init__(self, gp_name=None, report_from=None, report_to=None, **kwargs):
        ...
        self.sms_template ="GKA Quarterly Update: {} Please click the Link to get the Jun-Sep'18 update on \"GKA Class Visit\" Survey"
    ...
    def getHouseholdSurvey(self,district,date_range):
        ...
        if a.exists():
            ...
            for i in questions:
             ...
             raise ValueError("No community survey data for '{}' between {} and {}".format(self.district_name, self.report_from, self.report_to))
        return HHSurvey
