...
# ./manage.py dump_object schools.Student 1667626 1667628 1667629 1667630 1668934 > student.json
STUDENT_COUNT = 5
STUDENT_IDS = [1667626, 1667628, 1667629, 1667630, 1668934]

# ./manage.py dump_object schools.StudentStudentGroupRelation --query '{"student__in": [1668934, 1667630, 1667629, 1667628, 1667626]}' > studentgrouprelation.json
