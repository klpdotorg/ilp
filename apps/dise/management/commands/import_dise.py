...
class Command(BaseCommand):
    ...
    get_query = "\COPY (select 'replacestate', replaceyear, replacecolumns from dise_replaceyear_basic_data where lower(state_name)='replacestate' and sch_category<=10 and sch_management in (1,2,3)) TO 'replacefilename' NULL 'null' DELIMITER   '|' quote '\\\"' csv;"
    from_columns = "school_code, replace(school_name,'\\',''), district, block_name, cluster_name, village_name, pincode, rural_urban, medium_of_instruction, distance_brc, distance_crc, yeur_estd, pre_pry_yn, residential_sch_yn, sch_management, lowest_class, highest_class, sch_category, pre_pry_students, school_type, shift_school_yn, no_of_working_days, no_of_acad_inspection, residential_sch_type, pre_pry_teachers, visits_by_brc, visits_by_crc,school_dev_grant_recd, school_dev_grant_expnd, tlm_grant_recd, tlm_grant_expnd, funds_from_students_recd, funds_from_students_expnd, building_status, tot_clrooms, classrooms_in_good_condition, classrooms_require_major_repair, classrooms_require_minor_repair, other_rooms_in_good_cond, other_rooms_need_major_rep, other_rooms_need_minor_rep, toilet_common, toilet_boys, toilet_girls, kitchen_devices_grant, status_of_mdm, computer_aided_learnin_lab, separate_room_for_headmaster, electricity, boundary_wall, library_yn, playground, blackboard, books_in_library, drinking_water, medical_checkup, ramps, no_of_computers, male_tch, female_tch, noresp_tch, head_teacher, graduate_teachers, tch_with_professional_qualification, days_involved_in_non_tch_assgn, teachers_involved_in_non_tch_assgn , assembly_name, parliament_name, class1_total_enr_boys, class2_total_enr_boys, class3_total_enr_boys, class4_total_enr_boys, class5_total_enr_boys, class6_total_enr_boys, class7_total_enr_boys, class8_total_enr_boys, class1_total_enr_girls, class2_total_enr_girls, class3_total_enr_girls, class4_total_enr_girls, class5_total_enr_girls, class6_total_enr_girls, class7_total_enr_girls, class8_total_enr_girls, total_boys, total_girls, new_pincode, centroid"
