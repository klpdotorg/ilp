...
\ifnum {{loop.index}} = 1
    \begin{tabular}[t]{ll}
    \raisebox{-1cm}{\includegraphicsifexists[height=1.2cm]{"{{info.imagesqrdir}}{{num.competency}}_qrcode.png"}}  &
     \fcolorbox{black}{gray}{\parbox[t][1.2cm]{4.5cm}{\kn{ {{num.local_name}} }\kn{ಪರಿಕಲ್ಪನೆಯ ಫಲಿತಾಂಶ ಮಕ್ಕಳಲ್ಲಿ  ಇನ್ನು ಉತ್ತಮ ಪಡಿಸಲು ಈ} QR \kn{ಕೋಡ್ ಅನ್ನು ಸ್ಕಾನ್ ಮಾಡಿ}}}
    \end{tabular}
 \else 
     \ifnum {{loop.index}} = 2
     \hfill 
     \begin{tabular}[t]{ll}
     \raisebox{-1cm}{\includegraphicsifexists[height=1.2cm]{"{{info.imagesqrdir}}{{num.competency}}_qrcode.png"}} &
      \fcolorbox{black}{lightgray}{\parbox[t][1.2cm]{4.5cm}{\kn{ {{num.local_name}} }\kn{ಪರಿಕಲ್ಪನೆಯ ಫಲಿತಾಂಶ ಮಕ್ಕಳಲ್ಲಿ  ಇನ್ನು ಉತ್ತಮ ಪಡಿಸಲು ಈ} QR \kn{ಕೋಡ್ ಅನ್ನು ಸ್ಕಾನ್ ಮಾಡಿ}}}
     \end{tabular}
     \else
     \begin{center} 
     \begin{tabular}[t]{ll}
     \raisebox{-1cm}{\includegraphicsifexists[height=1.2cm]{"{{info.imagesqrdir}}{{num.competency}}_qrcode.png"}} &
     \fbox{\parbox[t][1.2cm]{4.5cm}{\kn{ {{num.local_name}} }\kn{ಪರಿಕಲ್ಪನೆಯ ಫಲಿತಾಂಶ ಮಕ್ಕಳಲ್ಲಿ  ಇನ್ನು ಉತ್ತಮ ಪಡಿಸಲು ಈ} QR \kn{ಕೋಡ್ ಅನ್ನು ಸ್ಕಾನ್ ಮಾಡಿ}}}
     \end{tabular}
     \end{center}
     \fi
\fi
