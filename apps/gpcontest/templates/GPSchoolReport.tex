...
\kn{ಜಿಲ್ಲೆ} : \kn{ {{schoolinfo.district_langname}} } \hfill  GP Id : {{schoolinfo.gpid}} \\
\kn{ತಾಲೂಕು} : \kn{ {{schoolinfo.block}_langname} } \hfill DISE Code : {{schoolinfo.disecode}} \\
\kn{ಗ್ರಾಮ ಪಂಚಾಯ್ತಿ} : \kn{ {{schoolinfo.gp_langname}} }\hfill \kn{ಶಾಲಾ ಹೆಸರು} : {{schoolinfo.schoolname}}\\
