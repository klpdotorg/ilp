...
\kn{ {{gpinfo.gp_langname}} } \kn{ ಗ್ರಾಮ ಪಂಚಾಯ್ತಿ,}\\ [1ex]
\kn{ {{gpinfo.block_langname}} } \kn{ ತಾಲೂಕು,}\\ [1ex]
\kn{ {{gpinfo.district_langname}} }\kn{ ಜಿಲ್ಲೆ.
\\~\\ [2ex]
ಮಾನ್ಯರೆ,
\\~\\
ವಿಷಯ: ಗಣಿತ ಕಲಿಕಾ ಆಂದೋಲನದ ಪರವಾಗಿ} \kn{ {{gpinfo.gp_langname}} }\kn{ ಗ್ರಾಮ ಪಂಚಾಯ್ತಿ ಮತ್ತು ಸಮುದಾಯದವರಿಗೆ ಅಭಿನಂದನೆಗಳು.
\\~\\
...
\kn{ಗ್ರಾಮ ಪಂಚಾಯ್ತಿ} : \kn{ {{gpinfo.gp_langname}} } \hfill \kn{ಜಿಲ್ಲೆ} : \kn{ {{gpinfo.district_langname}} }\rule{1cm}{0cm} \\ [1ex] 
\kn{ತಾಲೂಕ} : \kn{ {{gpinfo.block_langname}} } \hfill \kn{ಒಟ್ಟು ಶಾಲೆಗಳ ಸಂಖ್ಯೆ} : {{gpinfo.school_count}} \\~\\~\\~\\
