...
\rule{0cm}{0.3cm} {{ assessmentinfo[assessment]["class"] }}\kn{ನೇ ತರಗತಿ} & {{ assessmentinfo[assessment]["overall_scores"]["total"]}} & {{assessmentinfo[assessment]["overall_scores"]["below35"]}} & {{assessmentinfo[assessment]["overall_scores"]["35to60"]}} & {{assessmentinfo[assessment]["overall_scores"]["60to75"]}} & {{assessmentinfo[assessment]["overall_scores"]["75to100"]}} \\ \hline
{% endfor %}
\end{longtable}
...
{% for assessment in assessmentinfo %}
\rule{0cm}{0.3cm} {{assessmentinfo[assessment]["class"]}}\kn{ನೇ ತರಗತಿ} & {{assessmentinfo[assessment]["competency_scores"]["total"]}} & {{assessmentinfo[assessment]["competency_scores"]["Number Recognition"]}}  & {{assessmentinfo[assessment]["competency_scores"]["Place Value"]}} & {{assessmentinfo[assessment]["competency_scores"]["Addition"]}} & {{assessmentinfo[assessment]["competency_scores"]["Subtraction"]}} & {{assessmentinfo[assessment]["competency_scores"]["Multiplication"]}} & {{assessmentinfo[assessment]["competency_scores"]["Division"]}} \\ \hline
{% endfor %}
\end{longtable}
}
\endgroup
...
{
\centering{\kn{ಫಲಿತಾಂಶ : ಒಟ್ಟಾರೆಯಾಗಿ 5 ವರ್ಷ ಶಾಲೆಯಲ್ಲಿ ಕಲಿತ ಮಗು (6 ನೇ ತರಗತಿ) ಈ ಕೆಳಗಿನ ಮೂಲಕ್ರಿಯೆಯನ್ನು ಮಾಡಬಹುದು ಎಂದು ನಾವು ಪರಿಗಣಿಸಬಹುದು} (\kn{ಶೇಕಡವಾರು}).} \\[2ex]
