...
\kn{ತಾಲೂಕಿನ ಹೆಸರು} : {{blockinfo.name}}  \\ 
\kn{ಜಿಲ್ಲೆಯ ಹೆಸರು} : {{blockinfo.districtname}}\\
\kn{ಸ್ಪರ್ಧೆಯಲ್ಲಿ  ಭಾಗವಹಿಸಿದ ಗ್ರಾಮ ಪಂಚಾಯ್ತಿಗಳ ಸಂಖ್ಯೆ} : {{blockinfo.num_gps}} \\

{{blockinfo.name}} \kn{ತಾಲೂಕಿನಲ್ಲಿ ಗ್ರಾಮ ಪಂಚಾಯತಿ, ಸಾರ್ವಜನಿಕ ಶಿಕ್ಷಣ ಇಲಾಖೆ, ಸಮುದಾಯ ಮತ್ತು ಅಕ್ಷರ ಫೌಂಡೇಶನ್ ಸಹಭಾಗಿತ್ವದಲ್ಲಿ ಗ್ರಾಮ ಪಂಚಾಯತಿ ಮಟ್ಟದಲ್ಲಿ ನಡೆದ 4,5 ಮತ್ತು 6 ನೇ ತರಗತಿಯ ಶಾಲಾ ಮಕ್ಕಳ ಗಣಿತ ಸ್ಪರ್ಧೆಯ ಕಿರು ವರದಿ ಈ ಕೆಳಕಂಡಂತಿದೆ}\\[2ex]
