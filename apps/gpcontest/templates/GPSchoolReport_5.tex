...
\begin{longtable}{|P{1cm}|P{8cm}|P{3cm}|P{3cm}|} \hline
...
{% for question in assessmentinfo.class5.question_answers %}
...
{% for num in assessmentinfo.class5.deficiencies %}
\ifnum {{loop.index}} = 1
    \fbox{\parbox{4cm}{\kn{ {{ num.lang }} }\kn{ಪರಿಕಲ್ಪನೆಯ ಫಲಿತಾಂಶ ಮಕ್ಕಳಲ್ಲಿ  ಇನ್ನು ಉತ್ತಮ ಪಡಿಸಲು ಈ} QR \kn{ಕೋಡ್ ಅನ್ನು ಸ್ಕಾನ್ ಮಾಡಿ} }}
 \else 
     \ifnum {{loop.index}} = 2
     \hfill \fbox{\parbox{4cm}{\kn{ {{ num.lang }} }\kn{ಪರಿಕಲ್ಪನೆಯ ಫಲಿತಾಂಶ ಮಕ್ಕಳಲ್ಲಿ  ಇನ್ನು ಉತ್ತಮ ಪಡಿಸಲು ಈ} QR \kn{ಕೋಡ್ ಅನ್ನು ಸ್ಕಾನ್ ಮಾಡಿ} }}\\
     \else
     \centering{\fbox{\parbox{4cm}{\kn{ {{ num.lang }} }\kn{ಪರಿಕಲ್ಪನೆಯ ಫಲಿತಾಂಶ ಮಕ್ಕಳಲ್ಲಿ  ಇನ್ನು ಉತ್ತಮ ಪಡಿಸಲು ಈ} QR \kn{ಕೋಡ್ ಅನ್ನು ಸ್ಕಾನ್ ಮಾಡಿ} }}}
     \fi
\fi
{% endfor %}
