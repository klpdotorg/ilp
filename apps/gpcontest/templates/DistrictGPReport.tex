...
{{districtinfo.name}}\kn{ ಜಿಲ್ಲೆ.
\\~\\ [3ex]
ಮಾನ್ಯರೆ,
\\~\\
ವಿಷಯ: ಕರ್ನಾಟಕ ಸರ್ಕಾರ, ಸಾರ್ವಜನಿಕ ಶಿಕ್ಷಣ ಇಲಾಖೆ ಹಾಗೂ ಅಕ್ಷರ ಫೌಂಡೇಶನ್ ಸಹಭಾಗಿತ್ವದಲ್ಲಿ ಗಣಿತ ಕಲಿಕಾ ಆಂದೋಲನದ ಅಡಿಯಲ್ಲಿ} 2018-19\kn{ನೇ ಸಾಲಿನಲ್ಲಿ ನಡೆದ {{districtinfo.name}} ಜಿಲ್ಲೆಯ ಗ್ರಾಮ ಪಂಚಾಯತಿ ಮಟ್ಟದ ಸರ್ಕಾರಿ ಶಾಲಾ ಮಕ್ಕಳ ಗಣಿತ ಸ್ಪರ್ಧೆಯ ವರದಿ ಕುರಿತು.
\\~\\[5ex]
ಗಣಿತ ಕಲಿಕಾ ಆಂದೋಲನವು ಸರ್ಕಾರದ ಕಾರ್ಯಕ್ರಮವಾಗಿದ್ದು, ಗ್ರಾಮ ಪಂಚಾಯತಿ, ಸಾರ್ವಜನಿಕ ಶಿಕ್ಷಣ ಇಲಾಖೆ, ಸಮುದಾಯ ಹಾಗೂ ಅಕ್ಷರ ಫೌಂಡೇಶನ್ ಸಹಯೋಗದೊಂದಿಗೆ} 2018-19\kn{ನೇ ಸಾಲಿನಲ್ಲಿ {{districtinfo.name}} ಜಿಲ್ಲೆಯ {{districtinfo.num_blocks}} ತಾಲೂಕುಗಳಿಂದ {{districtinfo.num_gps}} ಗ್ರಾಮ ಪಂಚಾಯ್ತಿಗಳಲ್ಲಿ ಗಣಿತ ಸ್ಪರ್ಧೆ ನಡೆದಿದ್ದು, {{districtinfo.num_schools}} ಸರ್ಕಾರಿ ಶಾಲೆಗಳಿಂದ 4,5 ಮತ್ತು 6 ನೇ ತರಗತಿಯ {{districtinfo.totalstudents}} ಮಕ್ಕಳಿಗೆ ಗಣಿತ ಸ್ಪರ್ಧೆಯನ್ನು ಮಾಡಲಾಗಿದೆ.
\\~\\[3ex]
ಈ ಜಿಲ್ಲೆಯ ಎಲ್ಲ ಗ್ರಾಮ ಪಂಚಾಯತಿಯ ಅಧ್ಯಕ್ಷರು/ಸದಸ್ಯರು, ಪೋಷಕರು, ಎಸ್.ಡಿ.ಎಮ್.ಸಿ ಅಧ್ಯಕ್ಷರು/ಸದಸ್ಯರು, ಸ್ವಯಂ ಸೇವಕರು, ಗ್ರಾಮದ ಮುಖಂಡರು, ಶಿಕ್ಷಣ ಪ್ರೇಮಿಗಳು, ಮುಖ್ಯಗುರುಗಳು/ ಶಿಕ್ಷಕರು ಮತ್ತು ಸ್ಥಳೀಯ ಸಂಘ ಸಂಸ್ಥೆಯ ಸದಸ್ಯರುಗಳು, ಸರ್ಕಾರಿ ಶಾಲಾ ಮಕ್ಕಳ ಗಣಿತ ಸ್ಪರ್ಧೆಗೆ ಸಂಪನ್ಮೂಲ, ಸಹಕಾರ ಮತ್ತು ಸಹಭಾಗಿತ್ವದೊಂದಿಗೆ ಭಾಗವಹಿಸಿ ಯಶಸ್ವಿಗೊಳಿಸಿದ್ದಾರೆ.
\\~\\[2ex]
...
{
\setlength{\parindent}{0in}
\begin{center}\large{\kn{ಗಣಿತ ಕಲಿಕಾ ಆಂದೋಲನ}} \small{ {{info.year}} } \\ \end{center}
{% if percent_scores is none %}
~\\~\\
{% endif %}
\kn{ಗ್ರಾಮ ಪಂಚಾಯತಿ ಮಟ್ಟದ ಶಾಲಾ ಮಕ್ಕಳ ಗಣಿತ ಸ್ಪರ್ಧೆಯ ಜಿಲ್ಲಾ ವರದಿ} \\
\kn{ಜಿಲ್ಲೆಯ ಹೆಸರು} : {{districtinfo.name}}  \\ [1ex] 
...
{{districtinfo.name}} \kn{ಜಿಲ್ಲೆಯಲ್ಲಿ ಗ್ರಾಮ ಪಂಚಾಯತಿ, ಸಾರ್ವಜನಿಕ ಶಿಕ್ಷಣ ಇಲಾಖೆ, ಸಮುದಾಯ ಮತ್ತು ಅಕ್ಷರ ಫೌಂಡೇಶನ್ ಸಹಭಾಗಿತ್ವದಲ್ಲಿ ಗ್ರಾಮ ಪಂಚಾಯತಿ ಮಟ್ಟದಲ್ಲಿ ನಡೆದ 4,5 ಮತ್ತು 6 ನೇ ತರಗತಿಯ ಶಾಲಾ ಮಕ್ಕಳ ಗಣಿತ ಸ್ಪರ್ಧೆಯ ಕಿರು ವರದಿ ಈ ಕೆಳಕಂಡಂತಿದೆ}\\
\kn{ಈ ಜಿಲ್ಲಾ ವ್ಯಾಪ್ತಿಯಲ್ಲಿ} {{districtinfo.num_blocks}} \kn{ತಾಲೂಕುಗಳಿಂದ} {{districtinfo.num_gps}} \kn{ಗ್ರಾಮ ಪಂಚಾಯತಿಗಳಲ್ಲಿ  ಗಣಿತ ಸ್ಪರ್ಧೆ ನಡೆದಿದ್ದು,} {{districtinfo.num_schools}} \kn{ಸರ್ಕಾರಿ ಶಾಲೆಗಳಿಂದ 4,5 ಮತ್ತು 6 ನೇ ತರಗತಿಯ} {{districtinfo.totalstudents}} \kn{ಮಕ್ಕಳು ಸ್ಪರ್ಧೆಯಲ್ಲಿ ಭಾಗವಹಿಸಿದ್ದರು.}\\[2ex]
...
{% for assessment in percent_scores %}
\rule{0cm}{0.3cm} {{percent_scores[assessment]["Number Recognition"]}}&  {{percent_scores[assessment]["Place Value"]}} & {{percent_scores[assessment]["Addition"]}} & {{percent_scores[assessment]["Subtraction"]}} & {{percent_scores[assessment]["Multiplication"]}} &  {{percent_scores[assessment]["Division"]}}  \\ \hline
{% endfor %}
\end{longtable}
}
\endgroup
