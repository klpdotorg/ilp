...
\kn{ಇವರಿಗೆ,} \hfill  \kn{ {{info.month}} } {{info.year}} \\ [3ex]
\kn{ಮಾನ್ಯ ಅಧ್ಯಕ್ಷರು,}\\ [1ex]
\kn{ {{districtinfo.langname}} } {{districtinfo.name}}\kn{ ಜಿಲ್ಲೆ.
\\~\\ [3ex]
ಮಾನ್ಯರೆ,
\\~\\
\textbf{ವಿಷಯ:} ಕರ್ನಾಟಕ ಸರ್ಕಾರ, ಸಾರ್ವಜನಿಕ ಶಿಕ್ಷಣ ಇಲಾಖೆ ಹಾಗೂ ಅಕ್ಷರ ಫೌಂಡೇಶನ್ ಸಹಭಾಗಿತ್ವದಲ್ಲಿ ಗಣಿತ ಕಲಿಕಾ ಆಂದೋಲನದ ಅಡಿಯಲ್ಲಿ} 2018-19\kn{ನೇ ಸಾಲಿನಲ್ಲಿ ನಡೆದ} \kn{ {{districtinfo.langname}} } {{districtinfo.name}} \kn{ಜಿಲ್ಲೆಯ ಗ್ರಾಮ ಪಂಚಾಯತಿ ಮಟ್ಟದ ಸರ್ಕಾರಿ ಶಾಲಾ ಮಕ್ಕಳ ಗಣಿತ ಸ್ಪರ್ಧೆಯ ವರದಿ ಕುರಿತು.
\\~\\[3ex]
ಗಣಿತ ಕಲಿಕಾ ಆಂದೋಲನವು ಸರ್ಕಾರದ ಕಾರ್ಯಕ್ರಮವಾಗಿದ್ದು, ಗ್ರಾಮ ಪಂಚಾಯತಿ, ಸಾರ್ವಜನಿಕ ಶಿಕ್ಷಣ ಇಲಾಖೆ, ಸಮುದಾಯ ಹಾಗೂ ಅಕ್ಷರ ಫೌಂಡೇಶನ್ ಸಹಯೋಗದೊಂದಿಗೆ} 2018-19\kn{ನೇ ಸಾಲಿನಲ್ಲಿ} \kn{ {{districtinfo.langname}} } {{districtinfo.name}} \kn{ಜಿಲ್ಲೆಯ {{districtinfo.num_blocks}} ತಾಲೂಕುಗಳಿಂದ {{districtinfo.num_gps}} ಗ್ರಾಮ ಪಂಚಾಯ್ತಿಗಳಲ್ಲಿ ಗಣಿತ ಸ್ಪರ್ಧೆ ನಡೆದಿದ್ದು, {{districtinfo.num_schools}} ಸರ್ಕಾರಿ ಶಾಲೆಗಳಿಂದ 4,5 ಮತ್ತು 6 ನೇ ತರಗತಿಯ {{districtinfo.totalstudents}} ಮಕ್ಕಳಿಗೆ ಗಣಿತ ಸ್ಪರ್ಧೆಯನ್ನು ಮಾಡಲಾಗಿದೆ.
\\~\\[2ex]
...
{
\setlength{\parindent}{0in}
\begin{center}\large{\kn{ಗಣಿತ ಕಲಿಕಾ ಆಂದೋಲನ}} \small{ {{info.acadyear}} } \\ \end{center}
