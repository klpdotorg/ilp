...
{
\centering{\kn{ಈ ವರದಿಯಿಂದ ತಿಳಿಯುವುದೇನೆಂದರೆ,} \kn{5 ವರ್ಷ (6\kn{ನೇ ತರಗತಿ}) ಶಾಲಾ ದಿನಗಳನ್ನು ಮುಗಿಸಿದ} students_count\kn{ಮಕ್ಕಳಲ್ಲಿ,}} \\[2ex]
{{assessment["competency_scores"]["Addition"]}}\% \kn{ಮಕ್ಕಳಿಗೆ ಕೂಡುವ ಲೆಕ್ಕ ಬರುತ್ತದೆ.} \\ [2ex]
{{assessment["competency_scores"]["Subtraction"]}}\% \kn{ಮಕ್ಕಳಿಗೆ ಕಳೆಯುವ ಲೆಕ್ಕ ಬರುತ್ತದೆ.} \\ [2ex]
{{assessment["competency_scores"]["Multiplication"]}}\% \kn{ಮಕ್ಕಳಿಗೆ ಗುಣಿಸುವ ಲೆಕ್ಕ ಬರುತ್ತದೆ.} \\ [2ex]
{{assessment["competency_scores"]["Division"]}}\% \kn{ಮಕ್ಕಳಿಗೆ ಭಾಗಾಕಾರ ಲೆಕ್ಕ ಬರುತ್ತದೆ.} \\ [2ex]
