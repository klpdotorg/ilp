...
\\~\\
\kn{ {{info.block.boundary_langname}} }\kn{ತಾಲೂಕಿನ} {{info.block.num_gps}} \kn{ಗ್ರಾಮ ಪಂಚಾಯತಿಯ} {{info.block.num_schools}} \kn{ಶಾಲೆಗಳಲ್ಲಿ} 4,5 \kn{ಮತ್ತು} 6\kn{ನೇ ತರಗತಿಯ} {{info.block.num_students}} \kn{ಮಕ್ಕಳು ಗಣಿತ ಸ್ಪರ್ಧೆಗೆ ಭಾಗವಹಿಸಿರುತ್ತಾರೆ}
\\~\\
