...
\\~\\
\kn{ {{info.block.boundary_langname}} }\kn{ತಾಲೂಕಿನ} {{info.block.num_gps}} \kn{ಗ್ರಾಮ ಪಂಚಾಯತಿಯ}  {{info.block.num_schools}} \kn{ಶಾಲೆಗಳಿಂದ} 4,5 \kn{ಮತ್ತು} 6\kn{ನೇ ತರಗತಿಯ} {{info.block.num_students}} \kn{ಮಕ್ಕಳು  ಗಣಿತ ಸ್ಪರ್ಧೆಗೆ ಭಾಗವಹಿಸಿರುತ್ತಾರೆ.}
\\~\\
\kn{ಸದರಿ} \kn{ {{info.gp.lang_name}} }\kn{ಗ್ರಾಮ ಪಂಚಾಯತಿಯ ಒಟ್ಟು} {{info.gp.num_schools}} \kn{ಶಾಲೆಗಳಿಂದ} 4,5 \kn{ಮತ್ತು} 6\kn{ನೇ ತರಗತಿಯ} {{info.gp.num_students}} \kn{ಮಕ್ಕಳು  ಗಣಿತ ಸ್ಪರ್ಧೆಗೆ ಭಾಗವಹಿಸಿರುತ್ತಾರೆ.}
\\~\\
\kn{ {{info.designation_name}} }\kn{ {{info.designation}} }\kn{ {{info.district.boundary_langname}} }\kn{ಜಿಲ್ಲೆ} \kn{ {{info.block.boundary_langname}} }\kn{ತಾಲೂಕಿನ} \kn{ {{info.gp.lang_name}} }\kn{ಗ್ರಾಮ ಪಂಚಾಯತಿಯಲ್ಲಿ  ಸರ್ಕಾರಿ ಪ್ರಾಥಮಿಕ ಶಾಲಾ ಮಕ್ಕಳ ಗುಣಾತ್ಮಕ ಶಿಕ್ಷಣಕ್ಕಾಗಿ ನಿರ್ವಹಿಸುತ್ತಿರುವ ಪಾತ್ರ, ನೀಡುತ್ತಿರುವ ಪ್ರೇರಣೆ ಹಾಗೂ ಸಹಕಾರವನ್ನು ಗುರುತಿಸಿ ಈ ಸಂದರ್ಭದಲ್ಲಿ ಅಕ್ಷರ ಫೌಂಡೇಶನ್, ಬೆಂಗಳೂರು ಹೃದಯಪೂರ್ವಕ ಅಭಿವಂದನೆಗಳನ್ನು ಸಲ್ಲಿಸುತ್ತೇವೆ.}
\\~\\
