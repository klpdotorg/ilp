...
{% for assessment in percent_scores["assessments"] %}
\rule{0cm}{0.3cm} {{round(percent_scores["assessments"][assessment]["Addition"], 2)}} & {{round(percent_scores["assessments"][assessment]["Subtraction"],2)}} & {{percent_scores["assessments"][assessment]["Multiplication"]}} &  {{percent_scores["assessments"][assessment]["Division"]}}  \\ \hline
{% endfor %}
\end{longtable}
}
}
