...
\kn{ಗ್ರಾಮ ಪಂಚಾಯತಿ} : \kn{ {{schoolinfo.gp_langname}} } {{schoolinfo.gpname}}\hfill \kn{ಶಾಲಾ ಹೆಸರು} : {{schoolinfo.schoolname}}\\

\kn{ಗ್ರಾಮ ಪಂಚಾಯತಿ , ಶಿಕ್ಷಣ ಇಲಾಖೆ, ಸಮುದಾಯ ಮತ್ತು ಅಕ್ಷರ ಫೌಂಡೇಶನ್ ಸಹಭಾಗಿತ್ವದಲ್ಲಿ ದಿನಾಂಕ} {{schoolinfo.contestdate}} \kn{ರಂದು ಗ್ರಾಮ ಪಂಚಾಯತಿ ಮಟ್ಟದಲ್ಲಿ ನಡೆದ ನಿಮ್ಮ ಶಾಲಾ ಮಕ್ಕಳ ಗಣಿತ ಸ್ಪರ್ಧೆಯ ತರಗತಿವಾರು ಕಿರುವರದಿ ಈ ಕೆಳಕಂಡಂತಿದೆ}
...
{% for question in assessmentinfo.question_answers[:20] %}
...
\kn{ಜಿಲ್ಲಾ ಕ್ಷೇತ್ರ ವ್ಯವಸ್ಥಾಪಕರು, ಅಕ್ಷರ ಫೌಂಡೇಶನ್} \hfill \kn{ಅಧ್ಯಕ್ಷರು , ಗ್ರಾಮ ಪಂಚಾಯತಿ} \rule{0.5cm}{0cm}
}
