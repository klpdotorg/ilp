...
\kn{ಸ್ಪರ್ಧೆಯಲ್ಲಿ ಭಾಗವಹಿಸಿದ ಗ್ರಾಮ ಪಂಚಾಯತಿಗಳ ಸಂಖ್ಯೆ} : {{blockinfo.num_gps}} \\
