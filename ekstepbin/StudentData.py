...
json_file = os.path.join(dir, '../datapull/output3/ge_partner_data.json')
...
studentfile = os.path.join(dir, '../datapull/output3/student_mapping.txt')
stud_file = open(studentfile, 'w',encoding='utf-8')
keyfile = os.path.join(dir, '../.keys/ekstep-private.pem')
...
for line in open(json_file, 'r'):
    ...
    data = (jdata["edata"]["eks"]["data"])
    iv = jdata["edata"]["eks"]["iv"]
    key = jdata["edata"]["eks"]["key"]
