...
update assessments_question set display_text='Is the teacher carrying out the expected day''s timetable ?' where id=641;
update assessments_question set display_text='Are Children''s work books up to date ?' where id=646;
