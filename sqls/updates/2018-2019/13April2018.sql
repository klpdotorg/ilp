...
update common_respondenttype set state_code_id='ka' where char_id='BRC';
...
insert into common_respondenttype(char_id,name,state_code_id,active_id) values('NOD', 'GKA Nodal Officer', 'ka','AC');
