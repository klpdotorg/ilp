...
insert into boundary_electionboundary (id,dise_slug,const_ward_name,const_ward_type_id,state_id,status_id) values ('6303','','B.R Hills','GP','2','AC');
...
update schools_institution set gp_id=6303 where id in (6962,6963);
