...
echo "######################"
echo "STARTING SCRIPT - POPULATE INSTITUTION MANAGEMENT"
echo "######################"
dbname="$1";
echo $1
psql -U klp -d $dbname -f sql/institutionmanagement.sql
exit_status=$?
...
echo "######################"
echo "ENDING SCRIPT - POPULATE INSTITUTION MANAGEMENT"
echo "######################"
