...
tables = [
    {
        ...
        'getquery': "COPY(select id, 'ILP Konnect Community Survey', created_at, updated_at, 'akshara', 'AC' from stories_survey where id=7) TO 'replacefilename' NULL 'null' DELIMITER ',' quote '\\\"' csv;",
