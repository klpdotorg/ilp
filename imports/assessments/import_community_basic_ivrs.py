...
tables = [
    {
        ...
        'getquery': "COPY(select id, trim(name), created_at, updated_at, 'akshara', 'AC' from stories_survey where id=1) TO 'replacefilename' NULL 'null' DELIMITER ',' quote '\\\"' csv;",
    ...
    },
    {
        ...
        'getquery': "COPY(select questiongroup_id, question_id, sequence from stories_questiongroup_questions where questiongroup_id in (select id from stories_questiongroup where survey_id =1)) TO 'replacefilename' NULL 'null' DELIMITER ',' quote '\\\"' csv;",
