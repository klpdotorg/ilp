...
for filename in os.listdir(fromdir):
    ...
    for row in csv_f:
        ...
        if user_present is not None:
            ...
            not_present +=1
            sqlinsert = "insert into users_user(password,email,mobile_no,first_name,user_type_id,is_active,is_email_verified, is_mobile_verified, opted_email,is_superuser) values(%s, %s, %s, %s, %s, %s, %s, %s ,%s, %s) returning id;"
