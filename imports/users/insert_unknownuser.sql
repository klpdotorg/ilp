insert into users_user(id, password, email, mobile_no, first_name, last_name, is_active, is_email_verified, is_mobile_verified, opted_email, is_superuser, user_type_id, is_staff) values(10,'unknown', 'unknown', '0', 'Unknown','User', true, false, false, false, false, 'UK', false);
