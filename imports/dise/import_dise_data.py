...
tables = [
    {
        ...
        'query': "\COPY (select replaceyear, replacecolumns from dise_replaceyear_basic_data) TO '"+scriptdir+"/load/replacefile_replaceyear.csv' NULL 'null' DELIMITER   ',' quote '\\\"' csv;",
    }
]
