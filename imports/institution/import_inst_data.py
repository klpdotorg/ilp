...
tables=[
    ...
    },
    {
        ...
        'query': "COPY(select lang.id,lang.institution_id,case lang.moi_type_id "+mt_conv+" end  from schools_institution_languages lang, schools_institution s where lang.institution_id=s.id  and s.active=2) TO '$PWD/load/schools_institutionlanguage.csv' NULL 'null' DELIMITER   ',' quote '\\\"' csv;",
    }
]
